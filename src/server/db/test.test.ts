...
import { type TestUpdateObjectFull } from "@/types/test";
...
describe("Tests DAL", { retry: 2 }, () => {
  ...
  // it("updateTestFull should update a test", async () => {
  //   const userId = (await fixtures.createUser()).id;
  //   const test = await fixtures.createTest(userId);
  ...
  //     timeInMinutes: 35,
  //   };
  //   const updatedTest = await updateTestFull(test.id, values);

  //   for (const prop in values) {
  //     if (prop === "image" || prop === "questions") continue;
  //     const propTyped = prop as Exclude<
  //       keyof TestUpdateObjectFull,
  //       "image" | "questions"
  //     >;
  ...
  // it("updateTestFull should update test questions", async () => {
  //   const userId = (await fixtures.createUser()).id;
  //   const test = await fixtures.createTest(userId);
  ...
  // it("updateTestFull should delete removed questions", async () => {
  //   const userId = (await fixtures.createUser()).id;
  //   const test = await fixtures.createTest(userId);
  ...
  // it("updateTestFull should delete removed questions and upsert new questions", async () => {
  //   const userId = (await fixtures.createUser()).id;
  //   const test = await fixtures.createTest(userId);
